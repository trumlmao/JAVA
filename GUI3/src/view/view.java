...
public class view extends JFrame{
	...
	//JP_KHACHHANG 
		...
		JTable JTB_table2 = new JTable(new DefaultTableModel(data1, new Object[] {"Tên","Chức vụ","Số điện thoại"}));
		JScrollPane sc = new JScrollPane(JTB_table2);
		
		JTB_table2.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
		DefaultTableModel dm = (DefaultTableModel) JTB_table2.getModel();
		...
		delete.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				dm.removeRow(JTB_table2.getSelectedRow());
				...
				JTabbedPane tab1 = new JTabbedPane();
					...
					add_nhan_vien.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							dm.addRow(new Object[] {name,chucvu,Sodienthoai});
							nhanvien1.add(new DefaultMutableTreeNode(name));
						}
					});
					
					JPanel but = new JPanel();
					but.add(add_nhan_vien);
					but.add(delete);
					whs.setLayout(new BorderLayout());
					whs.add(but,BorderLayout.EAST);
